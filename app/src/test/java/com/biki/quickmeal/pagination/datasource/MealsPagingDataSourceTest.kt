...
class MealsPagingDataSourceTest {

    private var pagingDataSource: MealsPagingDataSource? = null
    ...
    fun setUp() {
        ...
        pagingDataSource = MealsPagingDataSource(repository)
    }
    ...
    fun loadInitial_Success() {
        ...
        pagingDataSource!!.ingredient.value = ingredient

        whenever(repository.getMeals(ingredient)).thenReturn(
            observable
        )
        ...
        verify(repository).getMeals(ingredient)
    ...
    fun loadInitial_Retry() {
        ...
        verify(repository, times(2)).getMeals(ingredient)
    }
